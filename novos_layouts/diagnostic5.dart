...
class DiagnosticApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ThemeLightPage(),
    );
  }
}

class ThemeLightPage extends StatefulWidget {
  const ThemeLightPage({super.key});

  @override
  State<ThemeLightPage> createState() => _ThemeLightPageState();
}

class _ThemeLightPageState extends State<ThemeLightPage>
