...
class ZenithApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ZenithPage(),
    );
  }
}

class ZenithPage extends StatefulWidget {
  const ZenithPage({super.key});

  @override
  State<ZenithPage> createState() => _ZenithPageState();
}

class _ZenithPageState extends State<ZenithPage> with TickerProviderStateMixin {
  // State
