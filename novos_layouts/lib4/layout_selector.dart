...
class LayoutSelector {
  ...
  static const List<Map<String, String>> availableLayouts = [
    ...
    },
    {
      'id': 'layout_08',
      'name': 'Eco-Minimal',
      'description': 'Minimalista com elementos ecológicos e cores naturais'
    },
    {
      'id': 'layout_11',
      'name': 'Aurora Glass',
      'description': 'Design futurista com efeito glassmorphism e gradientes aurora'
    },
    {
      'id': 'layout_14',
      'name': 'Cyberpunk Neon',
      'description': 'Tema cyberpunk com neon, glassmorphism e grades animadas'
    },
  ];
}
