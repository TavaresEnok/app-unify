...
const badgeVariants = cva(
  "inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-[11px] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default: "border-transparent bg-[#EAF7EF] text-[#157347] hover:bg-[#DFF2E7]",
        secondary: "border-transparent bg-[#EEF2FF] text-primary hover:bg-[#E2E8FF]",
        destructive: "border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80",
        outline: "border-[#E6E9EF] bg-white text-[#687181]",
      },
    },
    defaultVariants: {
      variant: "default",
