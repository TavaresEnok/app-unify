...
type ThemeProviderProps = { children: React.ReactNode; defaultTheme?: "dark" | "light" | "system"; storageKey?: string; };
type ThemeProviderState = { theme: "dark" | "light" | "system"; setTheme: (theme: "dark" | "light" | "system") => void; };
...
export function ThemeProvider({ children, defaultTheme = "system", storageKey = "vite-ui-theme", ...props }: ThemeProviderProps) {
  ...
  const value = { theme, setTheme: (theme: "dark" | "light" | "system") => { localStorage.setItem(storageKey, theme); setTheme(theme); } };
