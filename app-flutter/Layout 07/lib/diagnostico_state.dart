  ...
  factory DiagnosticoState.initial() {
    return DiagnosticoState(
      ...
      testResultsDisplay: {
        ...
        'batteryInfo': {'status': TestStatus.pending, 'result': null, 'label': 'Bateria e Energia'}, // NOVO
        'wifiInfo': {'status': TestStatus.pending, 'result': null, 'label': 'Informações de WiFi e DNS'},
        'lanScan': {'status': TestStatus.pending, 'result': null, 'label': 'Dispositivos na Rede (LAN)'}, // NOVO
        'publicIp': {'status': TestStatus.pending, 'result': null, 'label': 'IP Público'},
        'pingGateway': {'status': TestStatus.pending, 'result': null, 'label': 'Ping para o Roteador'},
        'pingGoogle': {'status': TestStatus.pending, 'result': null, 'label': 'Ping para Google DNS'},
        'pingCloudflare': {'status': TestStatus.pending, 'result': null, 'label': 'Ping para Cloudflare DNS'},
        'speedTestCustom': {'status': TestStatus.pending, 'result': null, 'label': 'Teste de Velocidade (Servidor do Provedor)'},
        'speedTestFast': {'status': TestStatus.pending, 'result': null, 'label': 'Teste de Velocidade (Referência Fast.com)'},
      },
    );
  }
