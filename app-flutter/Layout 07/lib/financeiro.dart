...
class _FinanceiroPageState extends State<FinanceiroPage> {
  ...
  void initState() {
    ...
    // Usa o config passado ou tenta criar um padrão (embora deva vir preenchido do painel)
    // Se falhar, o app pode quebrar, então assumimos que PainelPage fez o trabalho.
    if (widget.providerConfig != null) {
       _providerConfig = widget.providerConfig!;
    } else {
      // Fallback perigoso ou buscar de outra fonte se disponível
      // Mas como o Provider foi removido do main.dart, isso é o que temos.
      // Para evitar crash imediato:
      throw Exception("ProviderConfig não fornecido para FinanceiroPage");
    }
    ...
    // Obtém a URL base do SGP (usando o método auxiliar da classe DetailsSection)
    String sgpBaseUrl = _providerConfig.details.getEffectiveSgpUrl();
    // Fallback se vazio (como visto no Login)
