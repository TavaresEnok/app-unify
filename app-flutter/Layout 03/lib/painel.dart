...
class _PainelPageState extends State<PainelPage> {
  ...
  List<Widget> _buildPages() {
    ...
    // Converte os itens do menu para o formato esperado pelo dashboard
    final dashboardMenuItems = _menuItems.isNotEmpty
        ? _menuItems
            .map((item) => {
                  'id': item.id,
                  'label': item.name,
            ...
            .toList()
        : null; // Passa null se a lista estiver vazia para usar os defaults
        ...
        children: <Widget>[
          UserAccountsDrawerHeader(
            ...
            currentAccountPicture: CircleAvatar(
              ...
              child: Text(
                user.nome.isNotEmpty ? user.nome[0].toUpperCase() : 'C',
