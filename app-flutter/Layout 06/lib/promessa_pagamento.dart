...
class _PromessaPageState extends State<PromessaPage> {
  ...
  void initState() {
    ...
    final sgpParams = {
      ...
      "sgpBaseUrl": _providerConfig.config.integrations.sgpBaseUrl, // ADICIONADO
    };
